  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 antialiased py-16 px-6 sm:px-8 lg:px-12">
      <div className="max-w-5xl mx-auto grid lg:grid-cols-[0.9fr_1.1fr] gap-12 items-start">
        ...
        <div>
          ...
          <div className="mt-10 space-y-6">
            <a
              ...
              className="group flex gap-4 p-4 rounded-2xl border border-slate-100 bg-slate-50/60 hover:bg-slate-50 transition"
            >
              ...
              <div>
                ...
                <p className="text-slate-500 text-xs font-medium leading-none mb-1">
                  +62 812-3456-7890
                </p>
                <p className="text-indigo-600 text-[11px] font-bold group-hover:underline">
        ...
        {/* KOLOM KANAN: Formulir Pesan Masukan (Flat / Tanpa Card) */}
        <div className="lg:border-l lg:border-slate-100 lg:pl-12 w-full pt-8 lg:pt-0">
          ...
          <form className="space-y-4" onSubmit={handleSendMessage}>
            {isSuccess && (
              <div className="flex items-center gap-2 rounded-xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-xs font-semibold text-emerald-600">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="w-full mt-1.5 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm outline-none transition placeholder:text-slate-400 focus:border-indigo-600 focus:bg-white focus:ring-4 focus:ring-indigo-50"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                required
                className="w-full mt-1.5 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm outline-none transition placeholder:text-slate-400 focus:border-indigo-600 focus:bg-white focus:ring-4 focus:ring-indigo-50 resize-none"
            ...
            <Button
              type="submit"
              disabled={isSending}
              className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-xl shadow-md shadow-indigo-100 transition flex items-center justify-center gap-2"
            >
              {isSending ? (
                <>
