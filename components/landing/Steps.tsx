...
export default function StepsSection() {
  ...
  return (
    <section className="bg-background text-white rounded-t-[3.5rem] relative overflow-hidden flex flex-col justify-between pt-24 pb-12">
      {/* BACKGROUND DECOR */}
      <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-[#7F77DD]/20 blur-[100px] rounded-full" />
      <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#009B77]/10 blur-[100px] rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col flex-1">
        ...
        <div className="relative mb-16 flex flex-col justify-center">
          ...
          <div className="absolute top-9 left-0 w-full justify-center pointer-events-none hidden md:flex">
            <div className="w-[60%] h-px bg-linear-to-r from-transparent via-[#F59E0B] to-transparent opacity-20" />
            <div className="absolute w-[60%] h-px bg-linear-to-r from-transparent via-[#F59E0B] to-transparent blur-[2px] opacity-40" />
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className={`w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center relative z-20 transition-all duration-300 group-hover:scale-105 bg-[#1e293b] border backdrop-blur-sm`}
                >
                ...
                <div className="mt-6">
                  <h4
                    className="text-base md:text-lg font-bold mb-2 tracking-tight text-slate-100 transition-colors duration-200"
        ...
        <div className="my-8 mb-20 flex flex-col items-center text-center border-t border-[--color-border] pt-16">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-4 text-xs text-slate-500 font-semibold mt-1">
              <span className="flex items-center gap-1">
                <Zap size={13} className="text-[#F59E0B]" /> Tanpa Kartu Kredit
              </span>
              <span className="flex items-center gap-1">
                <Shield size={13} className="text-[#F59E0B]" /> Privasi data
                terjaga
              </span>
            </div>
          </div>
        ...
        {/* FOOTER AREA */}
        <footer className="border-t border-[--color-border] pt-8 space-y-6">
          ...
          <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4 pt-2">
            ...
            <div className="flex items-center gap-2 bg-[#1e293b] border border-[--color-border] px-3 py-1.5 rounded-full">
              <span className="relative flex h-1.5 w-1.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#009B77] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-[#009B77]"></span>
              </span>
