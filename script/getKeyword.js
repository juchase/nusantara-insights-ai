...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.keywordSummary.findMany({
                        select: {
                            productId: true,
                            word: true,
                            count: true,
                ...
                case 1:
                    ...
                    output = keywords
                        .map(function (k) { return "".concat(k.productId, " | ").concat(k.word, " | ").concat(k.count, " | ").concat(k.category); })
                        .join("\n");
                    // Simpan ke file keywords.txt
                    fs_1.default.writeFileSync("keywords.txt", output, "utf-8");
